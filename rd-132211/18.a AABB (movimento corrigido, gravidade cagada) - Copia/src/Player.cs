...
public class Player {
    ...
    private Vector3 pos_d = Vector3.Zero;
    ...
    */
    public void MoveRelative(float xa, float ya, float za, float speed) {
        ...
        pos_d += xa * speed * Vector3.Normalize(Vector3.Cross(direction, vertical));
        pos_d += ya * speed * vertical;
        pos_d += za * speed * Vector3.Normalize(new Vector3(direction.X, 0.0f, direction.Z));
